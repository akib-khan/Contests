...
class TabCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      color:((this.tab["closed"] &&this.tab["winner"] == "Me" )?Colors.green.shade400 : (this.tab["closed"] &&(this.tab["winner"] == this.tab["name"] ))?Colors.red.shade400 : (this.tab["closed"] ?Colors.grey : Colors.white) ),
      child: InkWell(
        borderRadius: BorderRadius.circular(18),
        onLongPress: () {
